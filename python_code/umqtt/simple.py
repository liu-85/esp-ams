# ============================================================================
# umqtt.simple —— MQTT 客户端（第三方库，直接纳入仓库）
#
# 来源: micropython-lib
#       https://github.com/micropython/micropython-lib
#       路径 micropython/umqtt.simple/umqtt/simple.py
# 许可: MIT
#
# 纳入仓库的原因: 本项目 bambu/bambu_mqtt.py 依赖它连接打印机。
#   如果只把项目文件烧进去而不带这个库，整片烧录后的板子会缺模块，
#   MQTT 功能直接不可用。放在这里，单文件固件才是真正自包含的。
# 除本注释外未做任何修改。
# ============================================================================
